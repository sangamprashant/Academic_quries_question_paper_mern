    ...
    <div style={{ marginTop: "70px" }}>
      <section className="container">
        ...
        <p>
          ...
          use of Academic Queries's Website, located at
          https://www.academicqueries.me/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Academic Queries if you do not
        ...
        <p>
          We employ the use of cookies. By accessing Academic Queries , you
          agreed to use cookies in agreement with the Academic Queries's Privacy
          Policy.{" "}
        </p>
        ...
        <p>
          ...
          intellectual property rights for all material on Academic Queries .
          All intellectual property rights are reserved. You may access this
          from Academic Queries for your own personal use subjected to
        ...
        <p>
          ...
          Academic Queries does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Academic Queries,its agents and/or affiliates.
          ...
          Academic Queries shall not be liable for the Comments or for any
        ...
        <p>
          ...
          sending an e-mail to Academic Queries. Please include your name, your

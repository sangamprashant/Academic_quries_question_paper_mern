  ...
  return (
    <div style={{ marginTop: "70px" }}>
      <section className="container">
        ...
        <p>
          At Academic Queries, accessible at undefined, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Academic Queries and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in Academic Queries. This policy is not
        ...
        <p>
          Academic Queries follows a standard procedure of using log files.
        ...
        <p>
          ...
          advertisements and links that appear on Academic Queries, which are
        ...
        <p>
          Academic Queries's Privacy Policy does not apply to other advertisers

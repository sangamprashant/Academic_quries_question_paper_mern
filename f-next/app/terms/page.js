...
function page() {
  return (
    <div style={{ marginTop: "70px" }}>
      ...
      <p>Welcome to Academic Queries !</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Academic Queries's Website, located at
        https://www.academicqueries.me/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Academic Queries if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing Academic Queries , you agreed
        to use cookies in agreement with the Academic Queries's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Academic Queries and/or its licensors own the
        intellectual property rights for all material on Academic Queries . All
        intellectual property rights are reserved. You may access this from
        Academic Queries for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Academic Queries </li>
        <li>Sell, rent or sub-license material from Academic Queries </li>
        <li>Reproduce, duplicate or copy material from Academic Queries </li>
        <li>Redistribute content from Academic Queries </li>
      </ul>
      ...
      <p>
        ...
        Academic Queries does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Academic Queries,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Academic Queries
      ...
      <p>
        Academic Queries reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Academic Queries a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Academic Queries; and (d) the
      ...
      <p>
        ...
        e-mail to Academic Queries. Please include your name, your organization
      ...
      <p>
        No use of Academic Queries's logo or other artwork will be allowed for
